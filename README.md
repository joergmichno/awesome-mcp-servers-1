...
- [ClawGuard](https://github.com/joergmichno/clawguard) - Prompt injection detection scanner for AI agents and MCP servers. 245 regex patterns, 15 languages, <10ms latency, EU AI Act compliance mapping. Zero dependencies.
